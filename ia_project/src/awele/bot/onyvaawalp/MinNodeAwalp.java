...
public class MinNodeAwalp extends MinMaxNodeAwalp{
     ...
     */
    MinNodeAwalp (Board board, int depth, double alpha, double beta)
    {
    ...
    {
        return new MaxNodeAwalp(board, depth, alpha, beta);
    }
