...
public class MinEnfoirax extends MinMaxEnfoirax {
     ...
     */
    MinEnfoirax (Board board, int depth, double alpha, double beta)
    {
    ...
    {
        return new MaxEnfoirax(board, depth, alpha, beta);
    }
