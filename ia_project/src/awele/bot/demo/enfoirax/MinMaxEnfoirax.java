 ...
 */
public abstract class MinMaxEnfoirax
{
     ...
     */
    public MinMaxEnfoirax(Board board, int depth, double alpha, double beta) {
                ...
                try
                {
                    ...
                    }else
                    {
                        ...
                        if (depth < MinMaxEnfoirax.maxDepth)
                        {
                            ...
                            MinMaxEnfoirax child = this.getNextNode (copy, depth + 1, alpha, beta);
    ...
    {
        MinMaxEnfoirax.maxDepth = maxDepth;
        MinMaxEnfoirax.player = board.getCurrentPlayer ();
    }

    private int diffScore (Board board)
    {
        return board.getScore (MinMaxEnfoirax.player) - board.getScore (Board.otherPlayer (MinMaxEnfoirax.player));
    }
     ...
     */
    protected abstract MinMaxEnfoirax getNextNode (Board board, int depth, double alpha, double beta);
