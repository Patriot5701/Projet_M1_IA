...
public class MaxHoulahoula extends MinMaxHoulahoula {
     ...
     */
    MaxHoulahoula (Board board, int depth, double alpha, double beta)
    {
    ...
    {
        return new MinHoulahoula(board, depth, alpha, beta);
    }
