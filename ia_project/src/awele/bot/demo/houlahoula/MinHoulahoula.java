...
import awele.bot.demo.enfoirax.MaxEnfoirax;
import awele.bot.demo.enfoirax.MinMaxEnfoirax;
import awele.core.Board;

public class MinHoulahoula extends MinMaxHoulahoula {
    /**
     * Constructeur pour un noeud initial
     * @param board La situation de jeu pour laquelle il faut prendre une décision
     */
    MinHoulahoula (Board board)
    {
     ...
     */
    MinHoulahoula (Board board, int depth, double alpha, double beta)
    {
     ...
     */
    @Override
    protected MinMaxHoulahoula getNextNode (Board board, int depth, double alpha, double beta)
    {
        return new MaxHoulahoula(board, depth, alpha, beta);
    }
