...
public class MaxSaligaud extends MinMaxSaligaud{
     ...
     */
    MaxSaligaud (Board board, int depth, double alpha, double beta)
    {
    ...
    {
        return new MinSaligaud(board, depth, alpha, beta);
    }
