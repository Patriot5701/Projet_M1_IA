...
public class MaxAlbatar  extends MinMaxAlbatar {
     ...
     */
    MaxAlbatar (Board board, int depth, double alpha, double beta)
    {
    ...
    {
        return new MinAlbatar(board, depth, alpha, beta);
    }
